...
`}
          ...
          <section className="healthcare-hero relative w-full">
            <div className="absolute inset-0 z-0 bg-gray-900">
              <img
                ...
                alt="Logistics services with shipping containers and transportation"
            ...
            >
              ...
              >
              Digitally empowering telecom operations by delivering automation, precision, and performance through
          ...
          <AnimatedSection animation="fadeIn" className="container mx-auto px-6 py-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <AnimatedSection animation="slideRight" delay={0.2} className="md:col-span-1">
                <div className="relative h-[400px] md:h-[500px] w-full rounded-lg overflow-hidden">
                  <img
                    ...
                    alt="Global logistics network with shipping containers and digital interface"
              ...
              <AnimatedSection animation="slideLeft" delay={0.4} className="md:col-span-2">
                ...
                The logistics sector is rapidly evolving, requiring faster, more efficient, and smarter supply chain
                  management solutions. At Imperative, we help logistics providers enhance operational workflows by
                  integrating automation, real-time tracking, and predictive analytics. Our solutions empower businesses
                  to streamline both back-office and customer-facing systems, ensuring seamless operations from start to
                  finish.
                </p>
                <p className="mb-6">
                We prioritize efficiency, cost savings, and scalability to meet the dynamic demands of the logistics
                  industry. Our platforms support both traditional and modern logistics providers, creating
                  opportunities for growth and innovation. With a focus on automation and data-driven insights, we help
                  you optimize every step of your supply chain.
                </p>
  ...
  <div className="container mx-auto px-6">
    <AnimatedSection animation="slideUp" className="text-center mb-12">
      <h2 className="text-3xl font-bold mb-4">Optimizing Logistics Operations for Efficiency and Cost Reduction</h2>
      <p className="max-w-4xl mx-auto text-center">
      Our solutions are designed to streamline your logistics operations, reduce costs, and increase speed.
      We focus on automating key processes, ensuring real-time tracking, and optimizing resources.
      </p>
    </AnimatedSection>
    ...
    >
      ...
      <AnimatedItem>
        ...
        >
          ...
          <h3 className="text-lg font-semibold mb-4 text-center">SmartTrack</h3>
          <div className="border border-orange-500 p-4 w-full flex-grow flex items-center">
            <p className="text-sm text-center">
            Real-time shipment tracking with route optimization and accurate delivery ETA predictions.
            </p>
          </div>
        </motion.div>
      </AnimatedItem>
      ...
      <AnimatedItem>
        ...
        >
          ...
          <h3 className="text-lg font-semibold mb-4 text-center">AI-based Load Optimization</h3>
          <div className="border border-orange-500 p-4 w-full flex-grow flex items-center">
            <p className="text-sm text-center">
            Maximize cargo space and minimize transportation costs using AI-powered algorithms.
            </p>
          </div>
        </motion.div>
      </AnimatedItem>
      ...
      <AnimatedItem>
        ...
        >
          ...
          <h3 className="text-lg font-semibold mb-4 text-center">Automated Billing & Invoicing</h3>
          <div className="border border-orange-500 p-4 w-full flex-grow flex items-center">
            <p className="text-sm text-center">
            Streamline the billing process with automatic document generation, payment tracking, and
            e-compliance checks.
            </p>
          </div>
        </motion.div>
      ...
      <AnimatedItem>
        ...
        >
          ...
          <h3 className="text-lg font-semibold mb-4 text-center">SupplyChain360</h3>
          <div className="border border-orange-500 p-4 w-full flex-grow flex items-center">
            <p className="text-sm text-center">
            An all-in-one platform for managing logistics, warehousing, order fulfillment, and
                        transportation.
            </p>
          </div>
        </motion.div>
            ...
            <div className="container mx-auto px-6">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                ...
                <AnimatedSection animation="slideRight" delay={0.3} className="md:col-span-5">
                  <div className="relative h-[450px] w-full">
                    ...
                    >
                      ...
                      alt="Logistics warehouse with workers and technology"
                        className="object-cover w-full h-full"
                      />
                    </motion.div>
                    ...
                    >
                      <img
                        src="https://images.unsplash.com/photo-1494412519320-aa613dfb7738?q=80&w=1470&auto=format&fit=crop"
                ...
                <AnimatedSection animation="slideLeft" delay={0.3} className="md:col-span-7">
                  ...
                  <p className="mb-8">
                  Our solutions have consistently delivered measurable improvements, directly enhancing key areas of
                    logistics operations. From cost reductions to faster delivery times, these results highlight the
                    effectiveness of our technology in streamlining processes and boosting performance.
                  </p>

                  <div className="space-y-6">
                    <StatCounter
                      title="Reduction in Transportation Costs"
                      value={25}
                      description="Significant savings in logistics operations by optimizing routes and reducing fuel usage."
                    />

                    <StatCounter
                      title="Faster Delivery Times"
                      value={40}
                      description="Increased speed in order fulfillment through route optimization and better resource allocation."
                    />

                    <StatCounter
                      title="Accuracy in Shipment Tracking"
                      value={99}
                      description="Real-time tracking ensuring accurate and timely updates for all shipments."
                    />
...
<motion.div
                      ...
                      viewport={{ once: true }}
                    >
                      <h3 className="text-xl font-semibold">Real-time monitoring of fleet performance</h3>
                      <p className="text-gray-600 mb-2">
                      Continuous performance monitoring to enhance efficiency, reduce idle time, and optimize fuel
                      consumption.
                      </p>
          ...
          <AnimatedSection animation="fadeIn" className="py-16 bg-gray-100">
            <div className="container mx-auto px-6">
              <AnimatedSection animation="slideUp" className="text-center mb-12">
                ...
                With over a decade of experience in logistics digitization, we offer scalable, compliant solutions
                tailored to logistics providers' needs. Our platforms provide flexible cloud or on-prem deployment,
                ensuring seamless integration with your systems, including TMS, WMS, ERP, and more.
                </p>
              </AnimatedSection>
